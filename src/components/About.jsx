...
export default function About(){
    return(
        <section className="w-screen h-auto bg-night-sky bg-top p-12 sm:p-14">
            ...
            <div className="flex flex-col gap-10 sm:flex-row sm:gapx-4 mx-auto max-w-screen-lg">
                <div /* Image */>
                    <img src='https://i0.wp.com/americasnationalparks.org/wp-content/uploads/2019/10/Enformer_2018_12_Nightsky.jpg?fit=3648%2C5472&ssl=1' alt="portfolio image" className="rounded-3xl"/>
                </div>
